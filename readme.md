...
The data, hint codes will be the same, except for you are expected to make a plot like below using `D3.js` or alternatives, the focus again is high performance data visualization
